...
const Landing = () => {
  ...
  const testimonials = [
    {
      ...
      avatar: 'SG',
      content: 'NexCatalog saved me 10+ hours every week. What used to take a full day now takes just 15 minutes!',
      rating: 5,
    },
    {
      name: 'Yash G',
  ...
  const faqs = [
    {
      question: 'Do I need any technical knowledge to use NexCatalog?',
      answer: 'Not at all! NexCatalog is designed for everyone. Simply upload your CSV or Excel file, configure your API keys, and click upload. No coding required.',
    },
    {
    ...
    },
    {
      ...
      answer: 'NexCatalog supports CSV, XLSX, XLSM, and XLS file formats. We provide a template to help you structure your product data correctly.',
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">
                Why Choose <span className="text-gradient">NexCatalog</span>?
              </h2>
                  ...
                  <div className="relative space-y-6">
                    ...
                    <div className="flex items-center gap-4 p-4 rounded-2xl bg-background/50 border border-border/30">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">Active sellers using NexCatalog</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-4 p-4 rounded-2xl bg-background/50 border border-border/30">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              See what our customers have to say about their experience with NexCatalog.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We're constantly improving NexCatalog. Here's what's on our roadmap.
            </p>
          </div>
      ...
      <section className="py-20 sm:py-32 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-white/80 mb-10 max-w-2xl mx-auto">
            Join hundreds of successful sellers who save hours every week with NexCatalog.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link to="/about">
              <Button size="lg" variant="outline" className="border-2 border-white/30 bg-white/10 text-white hover:bg-white/20 hover:text-white text-lg px-10 py-6">
                Learn More
              </Button>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                <img src="/nexcatalog_logo.png" alt="NexCatalog" className="h-12 w-auto" />
                <span className="text-2xl font-bold">NexCatalog</span>
              </div>
              <p className="text-muted-foreground mb-6 max-w-md">
                AI-powered platform for listings, pricing, and localization. Built for global sellers.
              </p>
              <div className="flex gap-4">
                <a href="https://github.com/yashsaraswat2004/NexCatalog" target="_blank" rel="noopener noreferrer" 
